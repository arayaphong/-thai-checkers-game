...
int main() {
    ...
    // Scenario: Capture Move with States API
    {
        ...
        std::vector<std::vector<Piece*>> grid(8, std::vector<Piece*>(8, nullptr));
        grid[2][2] = new Piece("AliceX", {2, 2});
        grid[3][3] = new Piece("BobO", {3, 3});
        Board board;
        board.initialize(grid);
        board.display();
    ...
    // Scenario: Multiple Capture Chain via States API
    {
        ...
        std::vector<std::vector<Piece*>> grid(8, std::vector<Piece*>(8, nullptr));
        grid[2][2] = new Piece("DanaX", {2, 2});
        grid[3][3] = new Piece("EveO", {3, 3});
        grid[5][5] = new Piece("FrankO", {5, 5});
        Board board;
        board.initialize(grid);
        board.display();
    ...
    // Scenario: Chain Capture with Multiple Choices via States API
    {
        ...
        std::vector<std::vector<Piece*>> grid(8, std::vector<Piece*>(8, nullptr));
        grid[0][0] = new Piece("DanaX", {0, 0});
        grid[1][1] = new Piece("EveO", {1, 1});
        grid[3][3] = new Piece("FrankO", {3, 3});
        grid[3][1] = new Piece("GailO", {3, 1});
        Board board;
        board.initialize(grid);
        board.display();
    ...
    // Scenario: No Moves Available
    {
        std::cout << "\n--- No Moves Available ---\n" << std::endl;
        std::vector<std::vector<Piece*>> grid(8, std::vector<Piece*>(8, nullptr));
        grid[4][4] = new Piece("AliceX", {4, 4});
        grid[5][5] = new Piece("AliceX", {5, 5});
        grid[5][3] = new Piece("BobO", {5, 3});
        grid[6][2] = new Piece("BobO", {6, 2});
